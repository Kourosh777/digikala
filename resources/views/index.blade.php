...
@section('content')
    ...
    <div class="component container-fluid">
        <div class="component-body5">
            <div class="row mycontainer">
                <div class="col px-2 medium-image">
                    <a href=""><img class="myimage img-fluid" src="./style/images/1.jpg" width="300px" alt=""></a>
                </div>
                <div class="col px-2 0 medium-image">
                    <a href=""><img class="myimage img-fluid" src="./style/images/2.jpg" width="300px" alt=""></a>
                </div>
                <div class="col px-2 0 medium-image">
                    <a href=""><img class="myimage img-fluid" src="./style/images/3.jpg" width="300px" alt=""></a>
                </div>
                <div class="col px-2 0 medium-image">
                    <a href=""><img class="myimage img-fluid" src="./style/images/4.jpg" width="300px" alt=""></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="component2 container-fluid">
    ...
    <!-- component 3 -->
    <div class="component3 container-fluid">
            ...
            <div class="row mx-5">
                ...
                <div class="col-4 d-flex">
                    <div class="row flex-column justify-content-between">
                        <a href="">
                            <img class="img-fluid img3" src="./style/images/11.jpg" alt="">
                        </a>
                        <a href="">
                            <img class="img-fluid img3" src="./style/images/12.jpg" alt="">
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="component4 container-fluid">
        <div class="component-body4">
            <div class="row mx-5">
                <div class="col-2 d-flex flex-column">
                    ...
                    <button type="button" class="btn btn-outline-light align-self-center mybtn">مشاهده همه > </button>
                </div>
                <div class="col-10 swiper-container swiper-container2">
                    <div class="swiper-wrapper mx-0">
                        <div class="card mycard swiper-slide">
                            <img class="card-img-top img5 img-fluid" src="./style/images/13.jpg" alt="Card image cap">
                            <div class="card-body">
                        ...
                        <div class="card mycard swiper-slide">
                            <img class="card-img-top img5 img-fluid" src="./style/images/14.jpg" alt="Card image cap">
                            <div class="card-body">
                                <p class="card-title mytitle"> ساعت هوشمند اسکمی مدل 1301GR</p>
                                <div class="myprice d-flex justify-content-end">
                                    <del class="text-muted pl-4">۷۰۰,۰۰۰</del>
                        ...
                        <div class="card mycard swiper-slide">
                            <img class="card-img-top img5 img-fluid" src="./style/images/15.jpg" alt="Card image cap">
                            <div class="card-body">
                                <p class="card-title mytitle"> ساعت هوشمند اسکمی مدل 1301GR</p>
                                <div class="myprice d-flex justify-content-end">
                                    <del class="text-muted pl-4">۷۰۰,۰۰۰</del>
                        ...
                        <div class="card mycard swiper-slide">
                            <img class="card-img-top img5 img-fluid" src="./style/images/16.jpg" alt="Card image cap">
                            <div class="card-body">
                                <p class="card-title mytitle"> ساعت هوشمند اسکمی مدل 1301GR</p>
                                <div class="myprice d-flex justify-content-end">
                                    <del class="text-muted pl-4">۷۰۰,۰۰۰</del>
    ...
    <div class="component5  container-fluid">
    ...
    <div class="component6  container-fluid">
        <div class="component-body">
            <div class="row">
                <div class="col py-2">
                    <div class=" my-border-title pb-2">

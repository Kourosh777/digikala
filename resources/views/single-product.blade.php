                            ...
                            <article>
                                ...
                                <section class="d-flex pt-3 pb-5">
                                    ...
                                    <ul class="product-param-list list-unstyled mb-0">
                                        <li class="d-flex">
                                            <div class="param-key">
                                                <span class="param-block">ابعاد</span>
                                            </div>
                                            <div class="param-value">
                                                <span class="param-block">164x75.8x8.9 میلی‌متر</span>
                                            </div>
                                        </li>
                                        <li class="d-flex">
                                            <div class="param-key">
                                                <span class="param-block">توضیحات سیم کارت</span>
                                            </div>
                                            <div class="param-value">
                                                <span class="param-block">سایز نانو (8.8 × 12.3 میلی‌متر)</span>
                                            </div>
                                        </li>
                                        <li class="d-flex">
                                            <div class="param-key">
                                                <span class="param-block">وزن</span>
                                            </div>
                                            <div class="param-value">
                                                <span class="param-block">205 گرم</span>
                                            </div>
                                        </li>
                                        <li class="d-flex">
                                            <div class="param-key">
                                                <span class="param-block">ساختار بدنه</span>
                                            </div>
                                            <div class="param-value">
                                                <span class="param-block">قاب پشتی و فریم از پلاستیک</span>
                                            </div>
                                        </li>
                                        <li class="d-flex">
                                            <div class="param-key">
                                                <span class="param-block">ویژگی‌های خاص</span>
                                            </div>
                                            <div class="param-value">
                                                <span class="param-block">مجهز به حس‌گر اثرانگشت , فبلت , مناسب
                                                    عکاسی</span>
                                            </div>
                                        </li>
                                        <li class="d-flex">
                                            <div class="param-key">
                                                <span class="param-block">تعداد سیم کارت</span>
                                            </div>
                                            <div class="param-value">
                                                <span class="param-block">دو سیم کارت</span>
                                            </div>
                                        </li>
                                    </ul>
                                </section>
                                        ...
                                        <div class="comments-list">
                                            <div class="comment-item">
                                                <div class="comment-row">
                                                    <span class="comment-title">خوب</span>
                                                </div>
                                                <div class="comment-row d-flex align-items-center">
                                                    <span class="comment-detail">۶ اردیبهشت ۱۴۰۰</span>
                                                    <span class="comment-detail d-flex align-items-center">
                                                        <div class="pr-2">کاربر دیجی‌کالا</div>
                                                    </span>
                                            ...
                                            <div class="question-list pt-4">
                                                ...
                                                <div class="question-item">
                                                    <div class="question-item-title">
                                                        ...
                                                        <span>ایا این گوشی اثر انگشت دارد</span>
                                                    </div>
                                                    <div class="question-item-reply">
                                                        ...
                                                        <div class="question-reply-footer d-flex justify-content-between pt-3">
                                                            <div class="question-reply-name">علی محمدی</div>
                                                            <div class="comment-helpful d-flex justify-content-end">
                                                                <div class="comment-helpful-question">
                                                                    آیا این دیدگاه برایتان مفید بود؟
                                                                </div>
